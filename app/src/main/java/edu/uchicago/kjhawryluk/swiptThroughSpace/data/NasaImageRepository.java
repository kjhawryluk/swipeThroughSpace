package edu.uchicago.kjhawryluk.swiptThroughSpace.data;
...
import edu.uchicago.kjhawryluk.swiptThroughSpace.data.local.NasaImageDatabase;
import edu.uchicago.kjhawryluk.swiptThroughSpace.data.local.dao.ImageDetailsDao;
import edu.uchicago.kjhawryluk.swiptThroughSpace.data.local.dao.QueryDao;
...
import edu.uchicago.kjhawryluk.swiptThroughSpace.data.remote.NasaImageRestService;
...
public class NasaImageRepository {
    ...
    private void queryImages(final String query, final int pageNum, final Stack<ImageDetails> prevPageImages) {
        mNasaImageRestService.searchImages(query, pageNum, ApiConstants.MEDIA_TYPE)
